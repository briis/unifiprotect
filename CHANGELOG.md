...
* Added Switch for changing High FPS mode from Lovelace (Issue #128). This switch will only be created for **G4 Cameras** as this is only supported on the G4 series of Cameras.
