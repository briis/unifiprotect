...
`unifiprotect.set_doorbell_lcd_message` | `entity_id` - Name of doorbell to display message on.<br>`text` - The message to display. | Display a Custom message on the LCD display on a G4 Doorbell
