...
Steps to migrate (will remove _all_ of your existing UniFi Protect entities)
...
* **BREAKING CHANGE** The domain for the ingration has been renamed from `unifiprotect` to `unifi_protect`.
